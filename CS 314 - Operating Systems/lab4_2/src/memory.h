...
// L2_BITS=12.
#define	MEMORY_L1_PAGE_SIZE_BITS 19	
#define	MEMORY_L2_PAGE_SIZE_BITS 13   
...
#define L1_MAX_ENTRIES 0x20     //L1 has 32 entries
#define L2_MAX_ENTRIES 0x40     //L2 has 64 entries
