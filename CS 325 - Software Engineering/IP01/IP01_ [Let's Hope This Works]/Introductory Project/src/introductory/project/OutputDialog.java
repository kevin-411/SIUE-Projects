...
public class OutputDialog extends javax.swing.JFrame
{
    ...
    public void setLabels(String name,String memo,String amount, int checkNumber, String dollarAmount){
        ...
        dateLabel.setText(Integer.toString(date.get(Calendar.MONTH) + 1) 
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(653, 362));
        setResizable(false);
        ...
        BackgroundImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/outputdialog/check.jpg"))); // NOI18N
        getContentPane().add(BackgroundImg);
        BackgroundImg.setBounds(0, 0, 647, 290);
