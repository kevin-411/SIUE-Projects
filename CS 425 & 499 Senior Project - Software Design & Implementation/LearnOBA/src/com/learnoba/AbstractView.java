...
public abstract class AbstractView<T extends Pane> extends Stage {
    ...
    public AbstractView(String resource, String title) {
        ...
        try {
            ...
            this.setTitle(title);
            if (OS.indexOf("mac") >= 0) {
                this.getIcons().setAll(new Image("file:resources/LearnOBA.icns"));
            } else {
                this.getIcons().setAll(new Image("file:resources/LearnOBA.png"),
                        new Image("file:resources/LearnOBA.ico"));
            }
