...
Partial Class KioskSelection
    ...
    Private Sub InitializeComponent()
        ...
        Me.ComboBox1.Items.AddRange(New Object() {"1st Floor Entrance", "Lower Level Main Entrance", "Lower Level Entrance 2", "Lower Level Entrance 3", "Lower Level Entrance 4"})
